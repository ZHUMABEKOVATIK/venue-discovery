...
# ------------------------------------------- Scanning -----------------------------------------------------
@router.post("/scan", response_model=QRScanResult, description="Owner miymanlardin qr kodin skan qilip usi apig'a mag'liwmatlardi jiberedi")
async def scan_qr(
    payload: QRScanIn,
    user: CurrentUserDep,
...
@router.post("/create", response_model=VenueOwnerOut, status_code=status.HTTP_201_CREATED)
